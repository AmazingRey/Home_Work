...
+ (void) initialize
{
    if (self == [DACircularProgressView class]) {
        ...
        [circularProgressViewAppearance setTrackTintColor:[[UIColor grayColor] colorWithAlphaComponent:0.3f]];
        ...
        [circularProgressViewAppearance setThicknessRatio:0.1f];
...
- (id)init
{
    return [super initWithFrame:CGRectMake(0.0f, 0.0f, 50.0f, 50.0f)];
}
