...
@protocol iCarouselScrollDelegate;
...
@property(nonatomic,readonly)BOOL          isBreakByUser;
...
#pragma mark
#pragma mark iCarouselScrollDelegate

@property(nonatomic,assign)id<iCarouselScrollDelegate>scrollDelegate;
@end
...
- (void)carousel:(iCarousel *)carousel didDoubleClickAtIndex:(NSInteger)index;
...
-(BOOL)iCarousel:(iCarousel*)view scrollShouldBegin:(UIPanGestureRecognizer *)panGesture;
