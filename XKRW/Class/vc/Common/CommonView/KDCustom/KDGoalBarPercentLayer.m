...
#define innerRadius    46.5
#define outerRadius    50.5
...
-(void)DrawRight:(CGContextRef)ctx {
    ...
    CGContextSetFillColorWithColor(ctx, [UIColor colorFromHexString:@"#ff6b6b"].CGColor);
...
-(void)DrawLeft:(CGContextRef)ctx {
    ...
    CGContextSetFillColorWithColor(ctx, [UIColor colorFromHexString:@"#62d0ca"].CGColor);
