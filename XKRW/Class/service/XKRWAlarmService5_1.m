...
static XKRWAlarmService5_1 *shareAlarmInstance;

@implementation XKRWAlarmService5_1

+ (id)shareService
{
    static dispatch_once_t predicate;
    dispatch_once(&predicate, ^{
        shareAlarmInstance = [[XKRWAlarmService5_1 alloc] init];
    });
    return shareAlarmInstance;
}
